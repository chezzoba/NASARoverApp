declare const _default: {
    ...
    delete: <T_2>(object: import("./types").GeneralObjectOrValue<T_2>, key: string | number) => import("./types").GeneralObjectOrValue<T_2>;
    pick: <T_3>(object: import("./types").GeneralObject<T_3>, keys: any[]) => import("./types").GeneralObject<T_3>;
